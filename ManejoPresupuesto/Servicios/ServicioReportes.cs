...
namespace ManejoPresupuesto.Servicios
{
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int año, int mes, dynamic ViewBag);
    }
    public class ServicioReportes : IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas>
            ObtenerReportesTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
        ...
        public async Task<ReporteTransaccionesDetalladas> 
            ObtenerReporteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int año, int mes, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
